...
├── LICENSE
├── hardware/
│   ├── orac_nt_vitality_v7e.h       # Core vitality functional
│   ├── orac_single_node_v7e.h       # Single node guardian
│   ├── orac_network_v7e.h           # Network guardian
│   ├── orac_stm32_v7e.ino           # STM32 single node sketch
...
**SDK:** [github.com/Kretski/orac-nt-ssd-thermal-sdk](https://github.com/Kretski/orac-nt-ssd-thermal-sdk)
